...
import ClaimRequestModel from "../../Modals/ClaimRequestModel";
                ...
                <div className="mt-4 flex gap-5">
                    {
                        loggedUser?.email !== email && <>
                            {
                                loggedUser?.email && <ClaimRequestModel id={_id} quessions={questions} ></ClaimRequestModel>
                            }

                            {
                                !loggedUser?.email && <AuthenticationModal id={_id}></AuthenticationModal>
                            }
                        </>
